...
export class TransbankService {
  ...
  async iniciarTransaccion(amount: number, sessionId: string, buyOrder: string, returnUrl: string) {
    try {
      console.log('Datos enviados a Transbank:', { amount, sessionId, buyOrder, returnUrl });
